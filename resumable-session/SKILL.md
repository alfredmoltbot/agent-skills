...
2. Revise los archivos modificados recientemente para familiarizarse con los cambios recientes en el código
3. Consulte el los archivos terminados en _Especificaciones.md para obtener detalles completos sobre los requisitos del proyecto
4. Siga las instrucciones en SESSION_RESUME.md para reanudar el desarrollo del proyecto
5. Cosulte al usuario sobre las siguientes tareas a realizar o cualquier duda que tenga sobre el proyecto.
6. Cada vez que se indique que una funcionalidad está bien implementada, marque la tarea como completada en SESSION_RESUME.md